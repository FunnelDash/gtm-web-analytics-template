...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "DashFi Web Analytics Snippet",
  ...
  "description": "DashFi Script tag that provides web analytics for the Ad Payment Protection Service",
  "containerContexts": [
    "WEB"
  ]
}
...
injectScript(dashfiScriptUrl,function () {
        if (typeof dashAnalytics !== 'undefined' && dashAnalytics.init) {
            dashAnalytics.init(data.CustomerId);
        } else {
            log('Error initialising the DashFi Analytics script');
        }
    },function () {
...
Created on 03/04/2025, 14:45:11
